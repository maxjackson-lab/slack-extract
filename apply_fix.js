...
// Replace the problematic aggregation logic
const oldCode = `        // Combine all analyses
        const combinedAnalysis = results
            .map(result => result.analysis)
            .join('\\n\\n---\\n\\n');`;

const newCode = `        // Create a single unified analysis instead of concatenating multiple analyses
...
console.log('The aggregation logic has been updated to create a single unified analysis instead of concatenating multiple analyses.');
